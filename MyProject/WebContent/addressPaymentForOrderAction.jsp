...
try{
	...
	PreparedStatement ps1=con.prepareStatement("update cart set address=?,city=?,state=?,country=?,mobileNumber=?,orderDate=sysdate,deliveryDate=sysdate + 5,paymentMethod=?,transactionId=?,status=? where email=?");
